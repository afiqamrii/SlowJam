...
export default function GradientText({
    ...
    return (
        <motion.div
            className={`relative flex flex-row items-center justify-center font-medium overflow-hidden cursor-pointer ${showBorder ? 'py-1 px-2 rounded-2xl' : ''} ${className}`}
        ...
        >
            {showBorder && (
                ...
                >
                    <div
                        className="absolute bg-black rounded-2xl z-[-1]"
