        ...
        <div className="min-h-screen pt-20 pb-12 px-5 max-w-4xl mx-auto font-(--font-gloria) overflow-x-hidden">
            ...
            <div className="flex flex-col gap-5 mb-8">
                ...
                <div className="flex items-center gap-6 border-b border-gray-100">
                    <button
                        onClick={() => { setSort('latest'); setSize(1); }}
                        className={`text-sm font-sans font-semibold transition-all relative pb-3 px-1 ${sort === 'latest' ? 'text-[var(--foreground)]' : 'text-gray-400 hover:text-gray-600'}`}
                    >
                        Latest Arrivals
                        {sort === 'latest' && (
                            <motion.div layoutId="sortTab" className="absolute bottom-[-1px] left-0 right-0 h-[2px] bg-[var(--accent)] rounded-t-full" />
                        )}
                    </button>
                    <button
                        onClick={() => { setSort('top'); setSize(1); }}
                        className={`text-sm font-sans font-semibold transition-all relative pb-3 px-1 ${sort === 'top' ? 'text-[var(--foreground)]' : 'text-gray-400 hover:text-gray-600'}`}
                    >
                ...
                <div className="relative w-full">
                    ...
                    <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-2xl py-3.5 pl-11 pr-5 font-sans text-sm text-foreground placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--accent)] shadow-sm"
                    />
                </div>
            </div>
                                        ...
                                        >
                                            <div className="w-full h-full bg-white border border-gray-100 hover:border-(--accent)/30 hover:shadow-lg shadow-sm rounded-2xl overflow-hidden flex flex-col transition-all group">
                                                ...
                                                <div className="flex items-center gap-3 px-4 py-3 bg-gray-50 border-t border-gray-100 group-hover:bg-[var(--accent)]/5 transition-colors">
                                                    ...
                                                    {/* Spotify icon & Favorite */}
                                                    <div className="flex items-center gap-2 shrink-0">
                                                        <FavoriteButton capsuleId={capsule.id} initialCount={capsule.favorites_count || 0} />
                                                        <div className="w-8 h-8 rounded-full bg-[#1DB954] flex items-center justify-center shadow-sm">
